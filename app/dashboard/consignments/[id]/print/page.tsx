...
export default async function PackingSlipPage({ params }: Props) {
  ...
  return (
    <>
      ...
      {/* Screen: instructions bar */}
      <PrintBar orderId={id} />

      {/* Packing slip — this is what prints */}
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-400 mt-2">Order ref: <span className="font-mono font-medium text-black">{orderRef}</span></p>
            </div>
          </div>
        </div>
