...
- subset: ONLY a parallel/variation name printed on the label that distinguishes this card from the base version of the same card design — examples: "Refractor", "Artist's Proof", "Silver", "Gold", "Black", "Camo", "Mojo Refractor", "X-Fractor", "Chrome", "Sapphire Edition", "Speckle", "Aqua". DO NOT put card-attribute words here. Specifically, NEVER put any of these in subset: "Rookie Card", "RC", "Rookie", "Autograph", "Auto", "Numbered", "Serial Numbered", "1st Year", "Hall of Fame". Those are attributes (set the corresponding boolean/list field instead — e.g. RC status belongs in features). If the label only shows the player + year + base set name with no parallel marker, subset is null.
